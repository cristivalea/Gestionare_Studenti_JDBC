...
//        try {
//            dataNastere = LocalDate.parse(strDataNastere, formatter); // Acum constructorul Data va procesa corect data
//        } catch (Exception e) {
...
//        try {
//            dataInmatriculare = LocalDate.parse(strDataInmatriculare, formatter); // La fel și pentru data de înmatriculare
//        } catch (Exception e) {
