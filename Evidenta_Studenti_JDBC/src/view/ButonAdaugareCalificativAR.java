...
public class ButonAdaugareCalificativAR extends JButton implements Comand {
    ...
    public ButonAdaugareCalificativAR(JComboBox<TipNota> tipNota, ButonCautare butonStudent, ButonCautareDiscipline butonDisciplina, JComboBox<String> calificativ, JDatePickerImpl dataExamen) {
    ...
    public void execute(){
        ...
        try {
            NotaCalificativ notaCalificativ = new NotaCalificativ(TipNota.A, codStudent, codDisciplina, dataE, tipCalificativ, promovat);
        }catch (Exception e){
            e.printStackTrace();
        }
    }
